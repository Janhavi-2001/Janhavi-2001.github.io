      ...
      <div className="quote-block">
        <div className="quote-corner-frame">
          ...
          <p className="description">
            ...
            <br /><br />
            Fluent in three Indian languages, I hold a JLPT N3 certification in Japanese and am a hobbyist learner of Mandarin Chinese. I believe that not only tools and skills, but also understanding diverse perspectives is key to building inclusive technology. I'm always open to enhancing my knowledge in software engineering, internationalization, and contributing to projects that make a difference in our perception of global software development.
          </p>
          <br />
        </div>
      </div>
